...
var html_url_prefix = "/Project-Moon-TTRPG";
var CONFIGURED_HTML_URL_PREFIX = "/Project-Moon-TTRPG";
...
var gzip_hash = '259401611465768385215939654579714130250'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/Project-Moon-TTRPG'  // this value is replaced by the actual url prefix when compiled
}
